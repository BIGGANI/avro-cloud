...
var db = require(__dirname + '/avrodict');
var RegexServer = require(__dirname + '/avroregexlib');
...
DBSearch.prototype = {
	...
	search: function (enText) {
        ...
        for(i in tableList) {
             ...
             retWords = retWords.concat(this._searchInArray(pattern, db[table]));
         }
